...
namespace Anzuelo.Application.Services.Implementations
{
    public class ServiceRol : IServiceRol
    {
        ...
        public ServiceRol(IRepositoryRol repository, IMapper mapper, ILogger<ServiceRol> logger)
        {
        ...
        public async Task<ICollection<RolDTO>> ListAync()
        {
            var list = await _repository.ListAsync();
            return _mapper.Map<ICollection<RolDTO>>(list);
        }
    }
}
